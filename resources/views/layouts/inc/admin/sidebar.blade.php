        ...
        <li class="nav-item {{ Request::is('admin/orders*') ? 'active':''  }}">
            ...
            <div class="collapse {{ Request::is('admin/orders*') ? 'show':'' }}" id="orders">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('admin/orders') ? 'active':'' }}" href="{{ url('admin/orders') }}">Orders Filter by Date</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('admin/orders/filterStatus') }}" href="{{ url('admin/orders/filterStatus') }}">Orders Filter by Status</a>
                    </li>
                </ul>
            </div>
        </li>
