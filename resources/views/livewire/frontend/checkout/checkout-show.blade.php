                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">{{$this->totalProductAmount}} EGP</span>
                        </h4>
                        <hr>
...
@push('scripts')
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AeKjAQ2e7jZcqGv8WU-3_F0hXoJIbWIYCoOpQ1ef76K2JUyeTNpddCOvOzDzR-XhmSQnfemoZwSy95Zc&currency=USD"></script>
    <script>
        paypal.Buttons({
            onClick: function()  {
