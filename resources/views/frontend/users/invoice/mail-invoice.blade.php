...
<body>
    ...
    <div class="text-center">
        ...
        <p>
            Thank you for purchasing with {{ $appSetting->website_name ?? "Noon"}}.
            <br/>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="10%">{{ $orderItem->price }} EGP</td>
                <td width="10%">{{ $orderItem->quantity }}</td>
                <td width="15%" class="fw-bold">{{ $orderItem->quantity * $orderItem->price }} EGP</td>
                @php
            ...
            <tr>
                ...
                <td colspan="1" class="total-heading">{{ $totalPrice }} EGP</td>
            </tr>
        </tbody>
    </table>
